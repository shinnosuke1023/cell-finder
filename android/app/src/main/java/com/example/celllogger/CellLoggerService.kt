package com.example.celllogger
...
class CellLoggerService : Service() {
    companion object {
        private const val TAG = "CellLogger-Service"
    }

    private val CHANNEL_ID = "cell_logger_channel"
    ...
    private fun createNotificationChannel() {
        ...
        val ch = NotificationChannel(CHANNEL_ID, "Cell Logger", NotificationManager.IMPORTANCE_LOW)
